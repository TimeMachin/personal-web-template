...
export default function GetInTouchButton() {
  ...
  return (
    <motion.button
      ...
      whileTap={{ scale: 0.96 }}
      className="relative flex items-center justify-center text-black h-[36px] px-4 rounded-[10px] bg-white hover:text-white/[.8] hover:bg-black/[.5] border border-white/25 cursor-pointer transition-colors duration-150"
    >
      ...
      <span className={`${fraunces.className} font-medium tracking-tight text-[13px] ml-2.5`}>Get in touch!</span>
    </motion.button>
  );
}