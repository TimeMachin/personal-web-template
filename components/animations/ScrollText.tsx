...
function __OriginkitBase_TextPath(props: Props) {
...
export default function TextPath(props: Record<string, unknown>) {
  return <__OriginkitBase_TextPath {...COMPONENT_DEFAULTS} {...props} />;
}
